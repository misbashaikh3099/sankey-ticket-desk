    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <p className="text-sm text-slate-400 text-center mb-6">
          Are you sure you want to close this ticket? Once closed, it cannot be
          reopened.
        </p>
      ...
      <div className="mb-6">
        ...
        {ticket.status !== "RESOLVED" && ticket.status !== "CLOSED" && (
          <div className="mt-4 px-4 py-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-sm text-amber-300">
            You can close this ticket once the vendor marks it as{" "}
            ...
            <div className="space-y-3">
              ...
              {ticket.resolvedAt && (
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-emerald-300 ml-auto text-right">
              ...
              {ticket.vendorId && (
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-violet-300 ml-auto font-mono text-xs">
                    {ticket.vendorId.slice(0, 12)}…
                  </span>
                </div>
              )}
